...
When(/^preencher os dados$/, () => {
    ...
    cy.get('.ng-invalid > .row > .col-md-6:nth-child(10) > .form-group > #quantityCheck').click()// qrd talões
    cy.get('.ng-invalid > .row > .col-md-6:nth-child(10) > .form-group > #quantityCheck').type('1')

    cy.get('.ng-invalid > .row > .col-md-6:nth-child(11) > .form-group > #quantityCheck').click() //qtd seção por talão
    cy.get('.ng-invalid > .row > .col-md-6:nth-child(11) > .form-group > #quantityCheck').type('2')

    cy.get('#mat-tab-content-0-0 > .mat-tab-body-content > .ng-star-inserted > .ng-invalid > .row:nth-child(1)').click() //clica fora

    cy.get(':nth-child(1) > :nth-child(1) > .form-group > #value').click() //qtd folhas 01
    cy.get(':nth-child(1) > :nth-child(1) > .form-group > #value').type('3')

    cy.get('.ng-star-inserted > .row > .ng-dirty:nth-child(2) > .form-group > #value').click() //valor reales
    cy.get('.ng-star-inserted > .row > .ng-dirty:nth-child(2) > .form-group > #value').type('50')

    cy.get('.ng-star-inserted > .row > .ng-untouched:nth-child(1) > .form-group > #value').click()//qtd folhas 02
    cy.get('.ng-star-inserted > .row > .ng-untouched:nth-child(1) > .form-group > #value').type('4')

    cy.get('.ng-star-inserted > .row > .ng-invalid:nth-child(2) > .form-group > #value').click() //valor reales
    cy.get('.ng-star-inserted > .row:nth-child(2) > .col-md-6:nth-child(2) > .form-group > #value').type('100')
