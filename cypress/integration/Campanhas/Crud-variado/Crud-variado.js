...
it('Campanha codigo variado' , () => {
    ...
    When(/^preencher os dados$/, () => {
        ...
        cy.get(':nth-child(9) > .form-group').click() 
        cy.get('.ng-invalid > .row > .col-md-6 > .form-group > #codeType').select('variable')       
        cy.get('.ng-invalid > .row > .col-md-6 > .form-group > #quantityCheck').type('1') 

        cy.get(':nth-child(1) > .form-group > #txtResumo > .ql-container > .ql-editor').click()
        cy.get('div.ng-untouched.ng-star-inserted > .row > :nth-child(1) > .form-group').click()
        cy.get(':nth-child(1) > .form-group > #value').type('2')
        cy.get('div.ng-untouched.ng-star-inserted > .row > :nth-child(2) > .form-group').click()
        cy.get(':nth-child(2) > .form-group > #value').type('1000')
